...
mysql tiki_rlp -e 'delete from sessions where expiry < UNIX_TIMESTAMP();'

mysql tiki_rlp -e 'truncate tiki_stats;'

mysql tiki_rlp -e 'delete from tiki_actionlog where lastmodif < UNIX_TIMESTAMP(CURRENT_DATE() - INTERVAL 6 MONTH);'
